...
const MOCK_USERS: ManagedUser[] = [
  ...
  },
  {
    ...
    isActive: true,
    lastLoginAt: '2026-05-22T08:30:00Z',
    teacherProfile: {
      specialization: 'Business English, Conversational English',
      availabilitySummary: 'Mon–Fri 9am–3pm PHT',
      internalStatus: 'ACTIVE',
      teachingNotes: 'Strong focus on corporate clients. Excellent at structured lesson delivery.',
  ...
  },
  {
    ...
    isActive: true,
    lastLoginAt: '2026-05-22T09:15:00Z',
    teacherProfile: {
      specialization: 'IELTS Preparation, Academic English',
      availabilitySummary: 'Mon–Fri 9am–3pm PHT',
      internalStatus: 'ACTIVE',
      teachingNotes: 'Specializes in exam prep. Very detail-oriented with writing tasks.',
      assignedStudentIds: ['u3', 'u4'],
      documentStatus: 'APPROVED',
      contractStatus: 'APPROVED',
    },
  },
  {
    ...
    isActive: true,
    lastLoginAt: '2026-05-22T10:30:00Z',
    teacherProfile: {
      specialization: 'Business English, Conversational English',
      availabilitySummary: 'Mon–Fri 9am–4pm PHT',
      internalStatus: 'ACTIVE',
      teachingNotes: 'Strong corporate background. Great at negotiation and presentation coaching.',
      assignedStudentIds: ['u1'],
      documentStatus: 'APPROVED',
      contractStatus: 'APPROVED',
    },
