...
.tv-select__trigger {
  ...
  transition:
    ...
    border-radius var(--tv-transition-fast);
}
...
.tv-select-wrapper--error .tv-select__trigger {
...
.tv-select__dropdown::-webkit-scrollbar-thumb { background: var(--tv-border); border-radius: var(--tv-radius-full); }
