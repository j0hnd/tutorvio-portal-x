...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'reporter_id', nullable: true, type: 'integer', example: 23),
        new OA\Property(property: 'assigned_to_id', nullable: true, type: 'integer', example: 7),
        new OA\Property(property: 'related_student_id', nullable: true, type: 'integer', example: 23),
        new OA\Property(property: 'related_teacher_id', nullable: true, type: 'integer', example: 17),
        new OA\Property(property: 'lesson_id', nullable: true, type: 'integer', example: 501),
        new OA\Property(property: 'class_schedule_id', nullable: true, type: 'integer', example: 88),
        ...
        new OA\Property(property: 'resolved_by', nullable: true, type: 'integer', example: 7),
        new OA\Property(property: 'reporter', nullable: true, type: 'object', example: ['id' => 23, 'name' => 'Ada Student', 'email' => 'ada@example.com']),
        new OA\Property(property: 'assigned_to', nullable: true, type: 'object', example: ['id' => 7, 'name' => 'Admin User', 'email' => 'admin@example.com']),
...
#[OA\Schema(
    ...
    type: 'object',
    example: [
        'lesson_record_id' => 501,
        'student' => ['id' => 23, 'name' => 'Ada Student'],
        'teacher' => ['id' => 17, 'name' => 'Taylor Teacher'],
        'course' => ['id' => 3, 'title' => 'Business English', 'placement_level' => 'B1'],
