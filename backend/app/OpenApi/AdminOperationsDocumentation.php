...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'filters', type: 'object', example: ['date_from' => '2026-06-01', 'date_to' => '2026-06-30', 'teacher_id' => 'usr_01J0TEACHER000000000000001']),
...
#[OA\Get(
    ...
    parameters: [
        ...
        new OA\Parameter(name: 'reporter_id', in: 'query', schema: new OA\Schema(type: 'string'), example: 'usr_01J0STUDENT000000000000001'),
        new OA\Parameter(name: 'assigned_to_id', in: 'query', schema: new OA\Schema(type: 'integer'), example: 7),
        new OA\Parameter(name: 'related_student_id', in: 'query', schema: new OA\Schema(type: 'string'), example: 'usr_01J0STUDENT000000000000001'),
        new OA\Parameter(name: 'related_teacher_id', in: 'query', schema: new OA\Schema(type: 'string'), example: 'usr_01J0TEACHER000000000000001'),
...
#[OA\Get(
    ...
    parameters: [
        ...
        new OA\Parameter(name: 'course_id', in: 'query', description: 'Course program public ID.', schema: new OA\Schema(type: 'string'), example: 'crs_01J0BUSINESS000000000001'),
