...
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: 'id', description: 'User public ID in client-facing responses.', type: 'string', example: 'usr_01J0STUDENT000000000000001'),
...
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: 'course_type_id', description: 'Internal numeric course type ID.', type: 'integer', example: 3),
        ...
        new OA\Property(property: 'learning_resource_ids', description: 'Internal numeric learning resource IDs visible to the actor.', type: 'array', items: new OA\Items(type: 'integer'), example: [11, 12]),
    ],
    type: 'object'
)]
#[OA\Schema(
...
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: 'student_ids', description: 'Internal numeric user IDs. Each user must have the student role and no active assignment for this course program.', type: 'array', items: new OA\Items(type: 'integer'), example: [23, 24]),
        new OA\Property(property: 'start_date', nullable: true, type: 'string', format: 'date', example: '2026-06-10'),
...
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: 'lesson_id', description: 'Internal numeric lesson ID. Teachers can only assign homework for their own lessons.', type: 'integer', example: 501),
        new OA\Property(property: 'student_id', description: 'Internal numeric student user ID. Must match the lesson student.', type: 'integer', example: 23),
        new OA\Property(property: 'title', type: 'string', maxLength: 255, example: 'Prepare five meeting updates'),
        new OA\Property(property: 'instructions', nullable: true, type: 'string', example: 'Write five short updates using past-tense project language.'),
        new OA\Property(property: 'due_date', nullable: true, type: 'string', format: 'date', example: '2026-06-07'),
        new OA\Property(property: 'documents', description: 'Internal numeric learning resource IDs visible to the actor.', type: 'array', items: new OA\Items(type: 'integer'), example: [31, 32]),
        new OA\Property(property: 'links', type: 'array', items: new OA\Items(type: 'string', format: 'uri'), example: ['https://example.com/homework-doc']),
    ],
    type: 'object'
)]
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'teacher_id', description: 'Internal numeric teacher user ID. Teachers can only create/update records as themselves for assigned students.', type: 'integer', example: 17),
        new OA\Property(property: 'skill_area', ref: '#/components/schemas/LearningSkillArea'),
...
#[OA\Get(
    ...
    parameters: [
        ...
        new OA\Parameter(name: 'course_type_id', in: 'query', description: 'Internal numeric course type ID.', schema: new OA\Schema(type: 'integer'), example: 3),
...
#[OA\Get(
    ...
    tags: ['Learning'],
    parameters: [
        new OA\Parameter(name: 'lesson_id', in: 'query', description: 'Internal numeric lesson ID.', schema: new OA\Schema(type: 'integer'), example: 501),
...
#[OA\Get(
    ...
    parameters: [
        new OA\Parameter(name: 'date_from', in: 'query', schema: new OA\Schema(type: 'string', format: 'date'), example: '2026-06-01'),
        new OA\Parameter(name: 'date_to', in: 'query', schema: new OA\Schema(type: 'string', format: 'date'), example: '2026-06-30'),
        new OA\Parameter(name: 'teacher_id', in: 'query', description: 'Internal numeric teacher user ID when supported by base report filters.', schema: new OA\Schema(type: 'integer'), example: 17),
        new OA\Parameter(name: 'student_id', in: 'query', description: 'Internal numeric student user ID when supported by base report filters.', schema: new OA\Schema(type: 'integer'), example: 23),
    ...
    responses: [
        new OA\Response(response: 200, description: 'Student progress report.', content: new OA\JsonContent(type: 'object', example: ['data' => ['summary' => ['students_count' => 1, 'progress_records_count' => 2, 'completed_lessons_count' => 8, 'status_counts' => ['in_progress' => 2]], 'rows' => [['student_id' => 23, 'student_name' => 'Alex Student', 'progress_level' => 'B1', 'previous_level' => 'A2', 'milestone' => 'Completed first progress checkpoint', 'skill_progress' => ['speaking' => ['summary' => 'Uses longer answers with fewer pauses.', 'status' => 'in_progress']], 'current_progress_status' => 'in_progress']], 'filters' => ['date_from' => '2026-06-01', 'date_to' => '2026-06-30', 'status' => 'in_progress']]])),
        new OA\Response(ref: '#/components/responses/UnauthorizedError', response: 401),
        new OA\Response(ref: '#/components/responses/ForbiddenError', response: 403),
        new OA\Response(ref: '#/components/responses/ValidationError', response: 422),
    ]
