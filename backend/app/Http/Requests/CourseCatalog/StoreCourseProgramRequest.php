...
/**
 * Validates create course program requests.
 *
...
{
    /**
     * Determine whether the authenticated user can submit create course program requests. This request adds no request-local authorization beyond route middleware, controller gates, or policies.
     */
    ...
    /**
     * Get validation rules for create course program requests.
     *
