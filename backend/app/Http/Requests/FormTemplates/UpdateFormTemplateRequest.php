...
/**
 * Validates update form template requests.
 *
...
class UpdateFormTemplateRequest extends FormRequest
{
    ...
    /**
     * Get validation rules for update form template requests.
     *
    ...
    {
        return $this->baseRules(creating: false);
    }

    /**
     * Register after-validation checks for cross-field or database-backed constraints on update form template requests.
     *
